...
def MolToChemDrawBlock(mol: Mol, format: CDXFormat = ...) -> str:
    """
        ...
        C++ signature :
            std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> MolToChemDrawBlock(RDKit::ROMol [,RDKit::v2::CDXFormat=rdkit.Chem.rdChemDraw.CDXFormat.CDXML])
    """
def MolsFromChemDrawBlock(block: str, sanitize: bool = True, removeHs: bool = True) -> typing.Any:
    """
        ...
        C++ signature :
            boost::python::api::object MolsFromChemDrawBlock(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> [,bool=True [,bool=True]])
    """
def MolsFromChemDrawFile(filename: typing.Any, sanitize: bool = True, removeHs: bool = True) -> tuple:
    """
        ...
        C++ signature :
            boost::python::tuple MolsFromChemDrawFile(boost::python::api::object [,bool=True [,bool=True]])
    """
def ReactionsFromChemDrawBlock(rxnblock: typing.Any, sanitize: bool = False, removeHs: bool = False) -> typing.Any:
    """
        ...
        C++ signature :
            boost::python::api::object ReactionsFromChemDrawBlock(boost::python::api::object [,bool=False [,bool=False]])
    """
def ReactionsFromChemDrawFile(filename: str, sanitize: bool = False, removeHs: bool = False) -> typing.Any:
    """
        ...
        C++ signature :
            boost::python::api::object ReactionsFromChemDrawFile(char const* [,bool=False [,bool=False]])
    """
